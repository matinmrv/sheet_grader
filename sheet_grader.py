...
def preprocess_image(img_path, width=800, height=1000):
...
def main():
    ...
    img_path = '/home/matin/Desktop/cam7.jpg'
    img, img_copy = preprocess_image(img_path)
    ...
    show_images(['mask', 'masked'], [mask, masked])
